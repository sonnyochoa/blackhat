...
# if it's Windows we need to to send ioctls to set up promiscuous mode
if os.name == "nt":
	...
	while True:
		...
		if ip_header.protocol == "ICMP":
			...
			if icmp_header.code == 3 and icmp_header.type ==3:
				# check to make sure host is in our target subnet
				if IPAddress(ip_header.src_address) in IPNetwork(subnet):
					# make sure the magic message is there
